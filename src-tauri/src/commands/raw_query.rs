...
#[tauri::command]
pub async fn raw_query(connection_string: String, sql: String) -> Result<QueryResponse, CommandError> {
    ...
    let messages = client.simple_query(&sql).await.map_err(CommandError::from)?;
